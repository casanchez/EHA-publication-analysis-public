...
To run this code base, you must have [R](https://www.r-project.org/) and
[python](https://www.python.org/) installed on your computer. The code
is primarily written in R but does depend a python library.

To reproduce the results, first clone or download this github repository
to your computer.

This repo uses [renv](https://rstudio.github.io/renv/articles/renv.html)
for dependency management. Run `renv::restore` to install all packages
from their recorded versions. Renv should handle creating virtual python
environments and installing python libraries as well.
...
- Please note that items in the rmd may not reflect the plos submission
  guidance for size or other aesthetic features.
